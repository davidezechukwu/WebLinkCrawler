...
namespace WebLinkCrawler
{
  public class Program
  {
    ...
    public static void Main(string[] args)
    {
      ...
      {
        Console.WriteLine("Usage: WebLinkCrawler.exe [DNS | IPV4 || IPV6]  MaxNumberOfPagesToCrawl(default is 50)");
        Console.WriteLine("for example: WebLinkCrawler.exe https://www.wiprodigital.com  20");
        Console.WriteLine("for example: WebLinkCrawler.exe https://www.wiprodigital.com/ ");
        Console.WriteLine("for example: WebLinkCrawler.exe http://www.wiprodigital.com ");
        Console.WriteLine("for example: WebLinkCrawler.exe https://wiprodigital.com 40");
        Console.WriteLine("for example: WebLinkCrawler.exe http://wiprodigital.com 40");
        Console.WriteLine("for example: WebLinkCrawler.exe http://wipro.digital 40");
        Console.WriteLine("for example: WebLinkCrawler.exe wiprodigital.com 40");
        Console.WriteLine("for example: WebLinkCrawler.exe 52.7.121.233 40");
        Console.WriteLine("for example: WebLinkCrawler.exe https://52.7.121.233:443/");
      ...
      string outputFileName = "WebLinksCrawler_" + args[0].Trim() + "_" + DateTime.UtcNow.ToLongDateString() + "_" + DateTime.UtcNow.ToLongTimeString() + ".xml";
      outputFileName = string.Join("_", outputFileName.Split(Path.GetInvalidFileNameChars()));
      string output = Crawl(args[0], new Dictionary<string, string>(), maxIndexedPageSize).OuterXml;
      File.WriteAllText(outputFileName, output);
      Console.WriteLine("");
      Console.WriteLine("");
      Console.WriteLine("");
      Console.WriteLine("Completed, I have nicely created an XML STEMAP file for your further use");
      Console.WriteLine(outputFileName);
      Console.WriteLine("It's contents is:-");
      Console.WriteLine("");
